 ...
 */
public class TestCountByCountry extends AvroPigUnitDriver<CountByCountryJob> {
  //input parameters
  ...
  * */
  public TestCountByCountry()
      throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException,
             NoSuchFieldException {
    super("src/main/pig/count_by_country.pig", "total");
  }
  ...
  * */
  ...
  public void testSingleInput()
    ...
    //execute script
    List<CountByCountryJob> results = executePigScript(args);

    //make expectations
    assertTrue(results != null, "Output is null");

    CountByCountryJob output = results.get(0);
  ...
  * */
  ...
  public void testMultipleInputMultipleCountryCodes()
    ...
    for (CountByCountryJob record : results) {
